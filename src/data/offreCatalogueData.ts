...
export const formationsInitiales: FormationOffer[] = [
  {
    ...
    alma4x: "247,50€/mois",
    format: "journee",
    features: [`Examen CMA inclus (${tarifs.fraisExamenCMA}€)`, "Support pédagogique complet", "Accès quiz en ligne", "Accompagnement personnalisé"],
    link: "/formations/taxi",
    category: "initiale",
    badge: "Examen inclus",
    amountCents: tarifs.initiale * 100,
    emoji: "🚕",
  },
  {
    ...
    alma4x: "247,50€/mois",
    format: "soiree",
    features: [`Examen CMA inclus (${tarifs.fraisExamenCMA}€)`, "Compatible avec emploi actuel", "Accès quiz en ligne", "Accompagnement personnalisé"],
    link: "/formations/taxi",
    category: "initiale",
    badge: "Examen inclus",
    amountCents: tarifs.initiale * 100,
...
export const formationsContinues: FormationOffer[] = [
  {
    ...
    category: "continue",
    amountCents: tarifs.continueVTC * 100,
    emoji: "🔄",
  },
  {
    id: "continue-taxi",
    ...
    category: "continue",
    amountCents: tarifs.continueTaxi * 100,
    emoji: "🔄",
  },
  {
    id: "continue-vmdtr",
    ...
    category: "continue",
    amountCents: tarifs.continueVMDTR * 100,
    emoji: "🔄",
  },
];
...
export const formationsPasserelles: FormationOffer[] = [
  {
    ...
    duration: `${tarifs.dureePasserelleTaxiHeures} heures`,
    durationHours: tarifs.dureePasserelleTaxiHeures,
    alma4x: "166,25€/mois",
    link: "/formations/taxi",
    category: "passerelle",
    amountCents: tarifs.passerelle * 100,
    emoji: "🚕",
  },
  {
    id: "passerelle-vtc",
    ...
    price: tarifs.passerelle,
    duration: `${tarifs.dureePasserelleHeures} heures`,
    durationHours: tarifs.dureePasserelleHeures,
    alma4x: "166,25€/mois",
    link: "/formations/vtc",
    category: "passerelle",
    amountCents: tarifs.passerelle * 100,
...
export const formationsMobilite: FormationOffer[] = [
  ...
  },
  {
    ...
    price: tarifs.mobiliteGeographique,
    duration: `${tarifs.dureeMobilite92Heures} heures`,
    durationHours: tarifs.dureeMobilite92Heures,
    alma4x: "110€/mois",
    link: "/contact",
    category: "mobilite",
    amountCents: tarifs.mobiliteGeographique * 100,
    emoji: "📍",
  },
  {
    id: "mobilite-75",
    ...
    price: tarifs.mobiliteGeographique,
    duration: `${tarifs.dureeMobilite75Heures} heures`,
    durationHours: tarifs.dureeMobilite75Heures,
    alma4x: "110€/mois",
    link: "/contact",
    category: "mobilite",
    amountCents: tarifs.mobiliteGeographique * 100,
...
export const formationRecupPoints: FormationOffer = {
  ...
  price: tarifs.recuperationPoints,
  ...
  amountCents: tarifs.recuperationPoints * 100,
  emoji: "🛡️",
};
...
export const formationsComplementaires: FormationOffer[] = [
  ...
  },
  {
    ...
    category: "complementaire",
    amountCents: tarifs.anglais * 100,
    emoji: "🇬🇧",
  },
  {
    id: "formation-admin",
    ...
    category: "complementaire",
    amountCents: tarifs.accompagnementAdmin * 100,
    emoji: "📋",
  },
];
