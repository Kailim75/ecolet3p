      ...
      >
        <div className="container-custom px-3 lg:px-4">
          <div className="flex items-center justify-between h-[72px] lg:h-[80px]">
            ...
            >
              <img src={isTransparent ? "/images/ecole-t3p-logo-white.svg" : "/images/ecole-t3p-logo-color.svg"} alt="ÉCOLE T3P — Centre de Formation Agréé" className="h-[48px] lg:h-[56px] w-auto block" width={187} height={56} loading="eager" decoding="async" />
            </Link>
