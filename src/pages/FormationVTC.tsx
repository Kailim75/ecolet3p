import { Car, FileText, CheckCircle, Target, Smartphone } from "lucide-react";
...
const FormationVTC = () => (
  <FormationPageTemplate
    ...
    crossSellLinks={[
      { title: "Location véhicule examen VTC", desc: "Pour les candidats libres : véhicule conforme + 2h de conduite dès 189€. Le véhicule est déjà inclus dans nos formations à 990€.", path: "/services/location-vehicule-examen" },
    ...
    programTotal={`${tarifs.dureeInitialeHeures} heures de formation`}
    programModules={[
      { title: "Réglementation VTC", topics: ["Loi Grandguillaume", "Statut VTC", "Droits et obligations", "LOTI et capacité"] },
      { title: "Gestion d'entreprise", topics: ["Micro-entreprise vs SASU", "Comptabilité simplifiée", "TVA et fiscalité", "Protection sociale"] },
      { title: "Sécurité routière", topics: ["Conduite préventive", "Gestion du stress", "Premiers secours", "Éco-conduite"] },
      { title: "Relation client premium", topics: ["Accueil haut de gamme", "Gestion des réclamations", "Discrétion professionnelle", "Fidélisation"] },
      { title: "Applications et plateformes", topics: ["Uber, Bolt, Heetch", "Optimisation des courses", "Gestion multi-apps", "Notation et avis"] },
      { title: "Anglais professionnel", topics: ["Vocabulaire transport", "Accueil clients étrangers", "Communication basique", "Expressions courantes"] },
    ]}
    prerequisites={[
    ...
    seoContent={[
      { title: "Devenir chauffeur VTC en 2026 : un métier en pleine croissance", text: "Le métier de chauffeur VTC (Voiture de Transport avec Chauffeur) connaît une croissance soutenue en Île-de-France, portée par la demande des plateformes Uber, Bolt et Heetch. ECOLE T3P, centre de formation VTC agréé par la Préfecture des Hauts-de-Seine situé au 3 rue Corneille à Montrouge (92120), forme les futurs chauffeurs VTC depuis 2014 avec un taux de réussite de 94% et plus de 2 000 professionnels accompagnés. Notre centre de formation VTC accueille les candidats du 92 (Hauts-de-Seine) et du 94 (Val-de-Marne)." },
      ...
      { title: "Formation VTC agréée Préfecture : centre Montrouge (92)", text: `ECOLE T3P est un centre de formation VTC agréé par la Préfecture des Hauts-de-Seine (agrément n° 23/005). Notre formation VTC est disponible en formule Essentiel à 990€ ou Premium à 1 190€ (avec coaching et suivi post-formation). Les deux formules incluent les frais d'examen CMA (${tarifs.fraisExamenCMA}€), 2 heures de conduite, le véhicule mis à disposition pour l'examen et l'accompagnement administratif pour la création de votre entreprise. Avec ${nbAvisGoogle} avis Google à 5 étoiles et un taux de réussite de 94%, nous formons les chauffeurs VTC des Hauts-de-Seine (92) depuis 2014. Le paiement en 4 fois sans frais via Alma rend notre formation VTC accessible à tous les budgets.` },
      { title: "Les étapes pour obtenir votre carte professionnelle VTC", text: "Le parcours pour devenir chauffeur VTC suit 5 étapes clés : 1) Vérifier les prérequis (permis B depuis 3 ans — 2 ans en conduite accompagnée, casier vierge, visite médicale). 2) S'inscrire à la formation VTC chez ECOLE T3P (990€, 3 formats disponibles). 3) Réussir l'examen VTC à la CMA (7 épreuves QCM). 4) Déposer le dossier de carte professionnelle VTC à la Préfecture (délai : 2 à 4 semaines). 5) Créer votre entreprise (micro-entreprise ou SASU) et vous inscrire au registre VTC. Notre équipe vous accompagne à chaque étape, de l'inscription jusqu'à votre première course." },
