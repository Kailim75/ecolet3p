...
const FormationVMDTR = () => (
  <FormationPageTemplate
    ...
    description="Formation moto-taxi VMDTR à Montrouge (92). Préparation examen T3P CMA, 94% de réussite. 990€ tout compris payable en 4x sans frais. Permis A obligatoire."
    ...
    seoContent={[
      { title: "Devenir moto-taxi VMDTR en 2026 : un métier premium en plein essor", text: "Le métier de conducteur VMDTR (Véhicule Motorisé à Deux ou Trois Roues) s'impose comme l'alternative premium du transport de personnes en milieu urbain. En Île-de-France, où le trafic routier est une contrainte quotidienne, le moto-taxi offre un service rapide et fiable, particulièrement prisé des cadres, hommes d'affaires et voyageurs pressés vers les aéroports. ECOLE T3P, centre de formation agréé par la Préfecture des Hauts-de-Seine, forme les futurs conducteurs VMDTR depuis 2014 avec un taux de réussite de 94% à l'examen T3P." },
      { title: "Le cadre réglementaire du VMDTR en France", text: "L'activité de moto-taxi est strictement réglementée par le Code des transports (articles L3123-1 à L3123-3). Le conducteur VMDTR doit détenir une carte professionnelle délivrée par la Préfecture après réussite à l'examen T3P organisé par la Chambre de Métiers et de l'Artisanat (CMA). Comme le VTC, le moto-taxi ne peut exercer que sur réservation préalable — la maraude est interdite. Le véhicule doit être assuré spécifiquement pour le transport de personnes à titre onéreux. La carte professionnelle VMDTR est valable 5 ans et son renouvellement nécessite une formation continue de 14 heures." },
      { title: "Sécurité : la priorité absolue de la formation VMDTR", text: "La sécurité est au cœur de la formation VMDTR chez ECOLE T3P. Notre programme consacre 8 heures à la sécurité deux-roues spécifique au transport de passagers : conduite défensive, anticipation des dangers, gestion du passager (communication, positionnement, répartition du poids), premiers secours et procédures d'urgence. Nos formateurs, tous anciens professionnels du transport moto, insistent sur les spécificités de la conduite avec passager : changement du centre de gravité, distances de freinage allongées, communication pilote-passager." },
      ...
      { title: "Pourquoi choisir ECOLE T3P pour votre formation VMDTR à Montrouge", text: "ECOLE T3P propose la seule formation VMDTR tout compris à 990€ dans les Hauts-de-Seine : frais d'examen CMA (241€) inclus, 2 heures de conduite avec moniteur, équipement passager fourni pour l'examen et accompagnement administratif pour la création d'entreprise. Notre centre au 3 rue Corneille, Montrouge (92120) est accessible par le métro ligne 4 (Mairie de Montrouge). Avec 359 avis Google 5 étoiles et plus de 2 000 chauffeurs T3P formés, nous sommes la référence en formation transport de personnes en Île-de-France." },
      ...
      { title: "Formation VMDTR accessible depuis tout le sud de Paris", text: "Notre centre de formation VMDTR à Montrouge est idéalement situé pour les motards d'Île-de-France. Facilement accessible depuis Paris (porte d'Orléans), Bagneux, Malakoff, Châtillon, Vanves, Issy-les-Moulineaux, Clamart, Antony, Sceaux et Boulogne-Billancourt. Métro ligne 4 (Mairie de Montrouge), parking moto gratuit à proximité. Le centre est à 15 minutes de moto depuis le périphérique parisien." },
    ]}
    relatedLinks={[
