...
const FormationVMDTR = () => (
  <FormationPageTemplate
    ...
    programModules={[
      { title: "Réglementation VMDTR", topics: ["Statut moto-taxi", "Code des transports", "Obligations professionnelles", "Assurances spécifiques"] },
      { title: "Sécurité deux-roues", topics: ["Conduite défensive", "Gestion des risques", "Équipements de sécurité", "Premiers secours"] },
      { title: "Conduite en milieu urbain", topics: ["Circulation inter-files", "Gestion du trafic dense", "Stationnement", "Itinéraires optimisés"] },
      { title: "Relation client", topics: ["Accueil passager", "Gestion du stress", "Communication", "Équipement passager"] },
      { title: "Gestion d'entreprise", topics: ["Création d'entreprise", "Comptabilité", "Fiscalité", "Applications de réservation"] },
    ...
    faqs={[
      ...
      { question: "Puis-je obtenir aussi la carte VTC en plus du VMDTR ?", answer: `Oui. Grâce à la Passerelle T3P, si vous avez réussi l'examen T3P depuis moins de 3 ans, vous pouvez obtenir votre carte VTC en seulement ${tarifs.dureePasserelleHeures} heures de formation complémentaire pour ${tarifs.passerelle}€. Cela vous permet de diversifier votre activité en combinant moto-taxi et VTC.` },
    ]}
    seoContent={[
      { title: "Devenir moto-taxi VMDTR en 2026 : un métier premium en plein essor", text: "Le métier de conducteur VMDTR (Véhicule Motorisé à Deux ou Trois Roues) s'impose comme l'alternative premium du transport de personnes en milieu urbain. En Île-de-France, où le trafic routier est une contrainte quotidienne, le moto-taxi offre un service rapide et fiable, particulièrement prisé des cadres, hommes d'affaires et voyageurs pressés vers les aéroports. ECOLE T3P, centre de formation VMDTR agréé par la Préfecture des Hauts-de-Seine, forme les futurs conducteurs moto-taxi depuis 2014 avec un taux de réussite de 94% à l'examen T3P. Notre formation VMDTR couvre l'ensemble des épreuves de l'examen T3P." },
      ...
      { title: "Centre de formation VMDTR agréé Préfecture à Montrouge (92)", text: `ECOLE T3P propose la formation VMDTR à partir de 990€ (formule Essentiel) ou 1 190€ (formule Premium) dans les Hauts-de-Seine : frais d'examen CMA (${tarifs.fraisExamenCMA}€) inclus, 2 heures de conduite avec moniteur, équipement passager fourni pour l'examen et accompagnement administratif pour la création d'entreprise. Notre centre de formation moto-taxi au 3 rue Corneille, Montrouge (92120) est agréé par la Préfecture (agrément VMDTR n° 23/006) et accessible par le métro ligne 4 (Mairie de Montrouge). Avec ${nbAvisGoogle} avis Google 5 étoiles et plus de 2 000 chauffeurs T3P formés, nous accompagnons les futurs professionnels du transport de personnes en Île-de-France depuis 2014.` },
    ...
    relatedLinks={[
      ...
      { title: "Passerelle VMDTR → VTC", desc: "Double carte professionnelle en 7h — 665€", path: "/passerelle-vtc-taxi" },
