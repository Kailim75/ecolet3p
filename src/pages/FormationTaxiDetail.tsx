...
const FormationTaxiDetail = () => (
  <FormationDetailTemplate
    ...
    faqs={[
      ...
      { question: "Combien de temps dure la formation ?", answer: "La formation Taxi est disponible en journée (1 semaine), en soirée (2 semaines) ou en e-learning (illimité jusqu'à l'examen)." },
