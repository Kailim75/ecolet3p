  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Formation transport PMR 14h à 290€ à Montrouge (92). Maîtrisez l'accueil des personnes à mobilité réduite. Paiement en 4× sans frais Alma." />
