...
const FormationTaxi = () => (
  <FormationPageTemplate
    ...
    ogTitle="Formation Taxi Montrouge 92 | 94% Réussite, dès 990€ en 4x"
    ...
    seoContent={[
      ...
      { title: "Formation taxi pas cher à Montrouge : à partir de 990€", text: "ECOLE T3P propose la formation taxi la plus compétitive des Hauts-de-Seine (92) et du Val-de-Marne (94) à partir de 990€ (formule Essentiel) ou 1 190€ (formule Premium avec coaching et suivi post-formation). Le tarif Essentiel inclut l'ensemble de la formation théorique, les frais d'inscription à l'examen CMA (241€), 2 heures de conduite avec un moniteur diplômé d'État et la mise à disposition d'un véhicule taxi équipé (lumineux, taximètre) le jour de l'examen. Avec le paiement en 4 fois sans frais via Alma, notre formation taxi agréée préfecture est accessible à tous les budgets. Aucun coût caché, aucun supplément." },
