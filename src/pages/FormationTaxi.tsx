...
const FormationTaxi = () => (
  <FormationPageTemplate
    ...
    description="Formation Taxi agréée Préfecture à Montrouge (92) — 94% de réussite, carte pro en 1 semaine, dès 990€ en 4x sans frais. Sessions chaque mois. Inscription en ligne sous 24h."
    ...
    programModules={[
      { title: "Réglementation du transport public", topics: ["Code des transports", "Statut du taxi", "Obligations professionnelles", "Sanctions et contrôles"] },
      { title: "Gestion d'entreprise", topics: ["Création d'entreprise", "Comptabilité", "Fiscalité", "Charges sociales"] },
      { title: "Sécurité routière", topics: ["Conduite préventive", "Gestion des risques", "Premiers secours", "Éco-conduite"] },
      { title: "Relation client", topics: ["Accueil client", "Gestion des conflits", "Communication", "Qualité de service"] },
      { title: "Développement commercial", topics: ["Fidélisation", "Applications", "Partenariats", "Stratégie tarifaire"] },
    ...
    faqs={[
      ...
      { question: "Puis-je exercer comme taxi et VTC en même temps ?", answer: `Non, un chauffeur ne peut pas exercer simultanément les deux activités. En revanche, grâce à la Passerelle T3P, vous pouvez obtenir votre carte VTC en seulement ${tarifs.dureePasserelleHeures}h de formation complémentaire (${tarifs.passerelle}€ chez ECOLE T3P) si vous avez réussi l'examen T3P depuis moins de 3 ans.` },
    ...
    relatedLinks={[
      ...
      { title: "Passerelle Taxi ↔ VTC", desc: "Double carte professionnelle dès 7h — 665€", path: "/passerelle-vtc-taxi" },
