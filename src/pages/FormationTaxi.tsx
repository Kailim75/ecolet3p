...
const FormationTaxi = () => (
  <FormationPageTemplate
    ...
    seoContent={[
      ...
      { title: "L'examen T3P Taxi : structure et préparation", text: "L'examen T3P (Transport Public Particulier de Personnes) est organisé par la Chambre de Métiers et de l'Artisanat (CMA). Il comporte un tronc commun de 5 épreuves (réglementation T3P, gestion, sécurité routière, français, anglais) et 2 épreuves spécifiques au taxi (développement commercial et connaissance du territoire). Chez ECOLE T3P, notre préparation intensive inclut des centaines de QCM d'entraînement actualisés, des examens blancs dans les conditions réelles et un suivi personnalisé. C'est cette méthode rigoureuse qui explique notre taux de réussite de 94%." },
      ...
      { title: "Pourquoi choisir ECOLE T3P pour votre formation Taxi à Montrouge", text: "ECOLE T3P offre la formation Taxi la plus complète des Hauts-de-Seine à un tarif tout compris de 990€. Ce prix inclut l'ensemble de la formation théorique, les frais d'inscription à l'examen CMA (241€), 2 heures de conduite avec un moniteur diplômé d'État et la mise à disposition d'un véhicule taxi équipé (lumineux, taximètre) le jour de l'examen. Notre centre, situé au 3 rue Corneille à Montrouge (92120), est à 2 minutes à pied du métro Mairie de Montrouge (ligne 4). Nous proposons le paiement en 4 fois sans frais via Alma." },
      ...
      { title: "Formation Taxi accessible depuis le sud de Paris et les Hauts-de-Seine", text: "Notre centre de formation Taxi à Montrouge est idéalement situé à la frontière de Paris (porte d'Orléans) et des Hauts-de-Seine. Il est facilement accessible depuis Bagneux, Malakoff, Châtillon, Vanves, Issy-les-Moulineaux, Clamart, Boulogne-Billancourt, Antony, Sceaux, Longjumeau et le 14ème arrondissement de Paris. Métro ligne 4 (Mairie de Montrouge), bus 68, 128 et N21. Parking disponible à proximité." },
    ]}
    relatedLinks={[
